                ...
                <div class="bg-white rounded-lg shadow-lg">
                    <div class="p-6">
                        ...
                        <form>
                            ...
                            <div id="motorista-fields" class="space-y-4 mb-4">
                                <div>
                                    <label for="vehicle" class="block text-sm font-medium text-gray-700 mb-1">Tipo de
                                        veículo</label>
                                    <select id="vehicle"
                                        ...
                                        <option value="caminhao-pequeno">Caminhão Pequeno</option>
                                        <option value="caminhao-medio">Caminhão Médio</option>
                                        <option value="caminhao-grande">Caminhão Grande</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <i data-lucide="map-pin"
                                            class="absolute left-3 top-3 h-4 w-4 text-gray-400"></i>
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('login-driver') }}" class="text-blue-600 hover:text-blue-700 text-sm">
