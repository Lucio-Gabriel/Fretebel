    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                Bem-vindo à
                <span class="text-primary">Fretebel</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <button class="bg-primary text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Começar Agora
                </button>
                <button class="border-2 border-primary text-primary px-8 py-3 rounded-lg font-semibold hover:bg-primary hover:text-white transition-colors">
                    Saiba Mais
                </button>
            </div>
        </div>
        ...
        <div class="mt-20 bg-primary rounded-2xl p-8 text-white">
            <div class="text-center mb-8">
                ...
                <p class="text-blue-100">Veja o impacto que nossa plataforma já causou</p>
            </div>

            <div class="grid md:grid-cols-4 gap-8 text-center">
                <div>
                    <div class="text-4xl font-bold mb-2">10K+</div>
                    <div class="text-blue-100">Usuários Ativos</div>
                </div>
                <div>
                    <div class="text-4xl font-bold mb-2">50K+</div>
                    <div class="text-blue-100">Projetos Criados</div>
                </div>
                <div>
        ...
        <div class="mt-20 text-center bg-white rounded-2xl p-12 shadow-sm border">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <button class="bg-primary text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-colors">
                    Criar Conta Gratuita
                </button>
                <button class="text-primary px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-50 transition-colors">
                    Agendar Demo
                </button>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center mb-4">
                        ...
                        <span class="ml-3 text-xl font-semibold">Welcome</span>
                    </div>
                    <p class="text-gray-400">Transformando a forma como você trabalha e colabora.</p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#" class="hover:text-white transition-colors">Ajuda</a></li>
